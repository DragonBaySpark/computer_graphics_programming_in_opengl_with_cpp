...
layout (binding =1) uniform sampler2D heightTexture;    // 纹理贴图
...
*/
    ...
    vec3 tex=texture(heightTexture, varyingTexCoord).xyz;
    ...
    // 将三个分量相加得到最终颜色
    fragColor = vec4((ambient + tex*( diffuse + specular)), 1.0);
}